...
//New will create a builder to elegantly create a new ExecStreamer
func New() ExecStreamerBuilder {
...
// OnStarted adds debug info to be printed out when errors occur
